...
import {
  KYCApplicationWithFlatFields,
  mockKYCApplications,
} from "@/lib/mockKycApplications";

export type { KYCApplicationWithFlatFields } from "@/lib/mockKycApplications";
export { mockKYCApplications } from "@/lib/mockKycApplications";
