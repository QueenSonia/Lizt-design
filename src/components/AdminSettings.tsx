        ...
        <div className="space-y-8">
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-lg">
            <div className="p-6">
              ...
              <p className="text-sm text-gray-600 mb-6">
                Configure your company&apos;s branding for all offer letters generated through Lizt. These settings apply to every landlord and property you manage.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label className="text-gray-900">Signature</Label>
                  <p className="text-sm text-gray-600 mb-3">
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-lg">
            <div className="p-6">
              <div className="flex items-center space-x-2 mb-6">
                <FileText className="w-5 h-5 text-gray-600" />
                <h2 className="text-gray-900">Default Offer Letter Template</h2>
              </div>
