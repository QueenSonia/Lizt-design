...
export const screenMap: ScreenMap = {
  landlord: {
    ...
    agents: lazy(() =>
      import("@/components/LandlordAgents").then((module) => ({
        default: withLandlordMobileProps(module.default),
      })),
    ),
    onboarding: lazy(() =>
      import("@/components/LandlordOnboarding").then((module) => ({
        default: withLandlordMobileProps(module.default),
      })),
    ),
    tenancies: lazy(() =>
    ...
    "maintenance-request-detail": lazy(() =>
      import("@/components/LandlordMaintenanceRequestDetail").then((module) => ({
