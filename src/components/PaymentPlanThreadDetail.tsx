        ...
        <div>
          <div className="relative pl-6">
            ...
            <div className="space-y-5">
              ...
              <div className="relative">
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                  <div className="grid grid-cols-[1fr_auto] gap-3 items-start">
                    <div>
                      <p className="text-sm font-semibold text-gray-900">Active Payment Plan</p>
                      <p className="text-lg font-semibold text-gray-900 mt-0.5">{formatCurrency(thread.amountDue)}</p>
              ...
              {/* Earlier activity — payment receipts and negotiation snapshots, newest first */}
              {history.map((event) => (
