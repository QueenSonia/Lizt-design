          ...
          <div className="space-y-3">
            {threads.map((thread) => (
              <button
                ...
                className="w-full flex items-center justify-between gap-3 px-4 py-3.5 text-left bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-colors"
              >
                <div className="min-w-0">
                  <p className="text-sm font-medium text-gray-900">{thread.title}</p>
                  <p className="text-xs text-gray-400 mt-0.5">
                    {formatCurrency(thread.amountDue)} · {proposalSummary(thread)}
                  </p>
                </div>
                <div className="flex items-center gap-3 shrink-0">
                  <div className="flex flex-col items-end gap-1">
                    ...
                    <span className="text-[11px] text-gray-400">{formatLastActivity(thread.lastActivityAt)}</span>
                  </div>
