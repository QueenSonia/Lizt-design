...
const MOCK_KYC_APPLICATIONS: Record<string, any> = {
  ...
  "mock-1": {
    ...
    employerAddress: "Plot 12, Lekki Phase 1, Lagos",
    workPhoneNumber: "+234 700 555 0101",
    monthlyNetIncome: "500000",
    lengthOfEmployment: "4 years",
    nextOfKinFullName: "Adaeze Okonkwo",
    nextOfKinRelationship: "Colleague",
    nextOfKinPhoneNumber: "+234 801 234 5678",
    intendedUseOfProperty: "Residential",
    numberOfOccupants: "2",
    parkingNeeds: "1 car space",
    additionalNotes: "Quiet professional, no pets",
    proposedRentAmount: 450000,
    rentPaymentFrequency: "Annually",
    property: { name: "Sunset View Apartments", address: "12 Admiralty Way, Lekki Phase 1, Lagos", status: "vacant" },
    submissionDate: "2024-12-01T14:30:00Z",
    outstandingBalance: 0,
    creditBalance: 0,
  },
  "mock-2": {
    ...
    employerAddress: "5 Adeola Odeku Street, Victoria Island, Lagos",
    workPhoneNumber: "+234 700 555 0202",
    monthlyNetIncome: "400000",
    lengthOfEmployment: "6 years",
    nextOfKinFullName: "Emeka Chukwu",
    nextOfKinRelationship: "Friend",
    nextOfKinPhoneNumber: "+234 807 654 3210",
    intendedUseOfProperty: "Residential",
    numberOfOccupants: "4",
    parkingNeeds: "2 car spaces",
    proposedRentAmount: 600000,
    rentPaymentFrequency: "Annually",
    property: { name: "Garden View Complex", address: "5 Adeola Odeku Street, Victoria Island, Lagos", status: "vacant" },
    submissionDate: "2024-11-28T09:15:00Z",
  ...
  "mock-3": {
    ...
    employmentStatus: "self-employed",
    occupation: "Designer",
    natureOfBusiness: "Creative & Design Services",
    businessName: "Adebayo Studio",
    businessAddress: "8 Olumide Close, Yaba, Lagos",
    businessDuration: "3 years",
    monthlyNetIncome: "250000",
    nextOfKinFullName: "Tunde Bello",
    nextOfKinRelationship: "Business Partner",
    nextOfKinPhoneNumber: "+234 802 111 2222",
    intendedUseOfProperty: "Residential",
    numberOfOccupants: "1",
    parkingNeeds: "1 car space",
    ...
    rentPaymentFrequency: "Annually",
    property: { name: "Sunset View Apartments", address: "12 Admiralty Way, Lekki Phase 1, Lagos", status: "vacant" },
    submissionDate: "2024-11-25T16:45:00Z",
    outstandingBalance: 0,
    creditBalance: 0,
  },
  "kyc-005": {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        firstName: "Tenant",
        lastName: "",
        property: { name: "Unknown Property", status: "vacant" },
